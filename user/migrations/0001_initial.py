    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bitcoin_wallet_address', models.CharField(blank=True, max_length=50)),
                ('etherium_wallet_address', models.CharField(blank=True, max_length=50)),
                ('usdt_wallet_address', models.CharField(blank=True, max_length=50)),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
